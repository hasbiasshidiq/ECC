//Orlando, G. and C. Paar, 2000. An efficient squaring architecture for GF(2m)
	...
	uint64_t multiplikasi(uint8_t get_part, uint32_t inA_0, uint32_t inA_1, uint32_t inA_2, uint32_t inA_3, uint32_t inA_4, uint32_t inA_5, uint32_t inB_0, uint32_t inB_1, uint32_t inB_2, uint32_t inB_3, uint32_t inB_4, uint32_t inB_5);
...
static inline void mult()
{
	...
	out_func[0] = multiplikasi(0, in1_mult[0], in1_mult[1], in1_mult[2], in1_mult[3], in1_mult[4], in1_mult[5], in2_mult[0], in2_mult[1], in2_mult[2], in2_mult[3], in2_mult[4], in2_mult[5]);
	
	out_func[1] = multiplikasi(1, in1_mult[0], in1_mult[1], in1_mult[2], in1_mult[3], in1_mult[4], in1_mult[5], in2_mult[0], in2_mult[1], in2_mult[2], in2_mult[3], in2_mult[4], in2_mult[5]);

	out_func[2] = multiplikasi(2, in1_mult[0], in1_mult[1], in1_mult[2], in1_mult[3], in1_mult[4], in1_mult[5], in2_mult[0], in2_mult[1], in2_mult[2], in2_mult[3], in2_mult[4], in2_mult[5]);
	
	out_mult[0] = out_func[0] & 0xffffffff;
	out_mult[1] = (out_func[0] >> 32) & 0xffffffff;
	out_mult[2] = out_func[1] & 0xffffffff;
	out_mult[3] = (out_func[1] >> 32) & 0xffffffff;
	out_mult[4] = out_func[2] & 0xffffffff;
	out_mult[5] = (out_func[2] >> 32) & 0xffffffff;
