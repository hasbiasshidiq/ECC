...
echo ECC163_lib.dtbo > /config/device-tree/overlays/test/path
...
: ${CS_TIME:=0}
INPUT_BIN=input_ecc163_lib.bin
REFERENCE_BIN=output_ecc163_lib.bin
OUTPUT_BIN=result_ecc163_lib.bin
